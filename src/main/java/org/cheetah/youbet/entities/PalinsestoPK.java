 ...
 */
@Embeddable
public class PalinsestoPK implements Serializable {
    ...
    public PalinsestoPK(int idPalinsesto, int idAvvenimento) {
    ...
    public boolean equals(Object object) {
        ...
        if (!(object instanceof PalinsestoPK)) {
            return false;
        }
        PalinsestoPK other = (PalinsestoPK) object;
    ...
    public String toString() {
        return "org.cheetah.youbet.entities.PalinsestoPK[ idPalinsesto=" + idPalinsesto + ", idAvvenimento=" + idAvvenimento + " ]";
    }
